...
/**
 * Explicit class-placement boundary.
 *
 * This service changes the student's current class only. It deliberately
 * does not invent automatic promotion rules; those belong to a future
 * configurable progression policy.
 */
public final class StudentClassAssignmentService {
    ...
    public StudentClassAssignmentService(
        ...
        if (students == null || classes == null || accessContext == null) {
            throw new IllegalArgumentException("class assignment dependencies are required");
        }
